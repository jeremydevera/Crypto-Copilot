...
export default function NotificationPanel({ vm }: NotificationSystemProps) {
  ...
  return (
    <>
      {/* Bell icon — designed to sit in a top-right header bar */}
      <button
      ...
      >
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7A9 9 0 0012 0a9 9 0 00-6 2.292v.7A8.967 8.967 0 010 15.772a23.848 23.848 0 005.454 1.31M14.857 17.082a3.001 3.001 0 01-5.714 0M14.857 17.082H9.143" />
        </svg>
        {unreadCount > 0 && (
